...
<details><summary>Missed class? Expand for audio.</summary>
    <figure role="figure">
        <figcaption>If you missed class, or you just want to try again in a non-shared space, you can use this media player for an audio version of the text-based writing prompts that follow:</figcaption>
        <audio
            controls
